...
class BeersListViewModel(private val getBeerListUseCase: GetBeerListUseCase, private val dispatcherProvider: CorroutineDispatcherProvider): ViewModel() {
    ...
    fun getBeerList(page: Int = 1) {
        viewModelScope.launch(dispatcherProvider.io) {
            getBeerListUseCase(getBeerListUseCase.Params(page)).also(::treatGetBeerResult)
        }
    }
